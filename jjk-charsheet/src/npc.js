      ...
      <div class="party-item party-item--gm-openable npc-item" data-npc-id="${npc.id}"
        ...
        <div class="npc-core-stats" style="display: grid; grid-template-columns: repeat(5, 1fr); text-align: left; gap: 2px 0;">
          ...
          <div class="npc-core-stat-value-row" style="grid-column: 1 / -1; display: grid; grid-template-columns: repeat(5, 1fr); text-align: left;">
            <span class="npc-core-stat-value" style="display: flex; justify-content: center; align-items: center;">${npc.stats?.power?.score !== "" && npc.stats?.power?.score != null ? npc.stats.power.score : "—"}</span>
            <span class="npc-core-stat-value" style="display: flex; justify-content: center; align-items: center;">${npc.stats?.speed?.score !== "" && npc.stats?.speed?.score != null ? npc.stats.speed.score : "—"}</span>
            <span class="npc-core-stat-value" style="display: flex; justify-content: center; align-items: center;">${npc.stats?.technique?.score !== "" && npc.stats?.technique?.score != null ? npc.stats.technique.score : "—"}</span>
            <span class="npc-core-stat-value" style="display: flex; justify-content: center; align-items: center;">${npc.stats?.intelligence?.score !== "" && npc.stats?.intelligence?.score != null ? npc.stats.intelligence.score : "—"}</span>
            <span class="npc-core-stat-value" style="display: flex; justify-content: center; align-items: center;">${npc.stats?.cooperation?.score !== "" && npc.stats?.cooperation?.score != null ? npc.stats.cooperation.score : "—"}</span>
          </div>
        </div>
      </div>`;
  }).join("");
